            ...
            <div className="h-[calc(100vh-80px)] bg-slate-200">
                <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-center flex-col">
                    ...
                    <div className="max-w-xs w-full flex justify-between mt-5">
                        <a href="#" className="font-bold text-white bg-slate-600 h-10 flex items-center justify-center px-6 rounded-xl transition-colors hover:bg-slate-800">Tutor</a>
                        <a href="#" className="font-bold text-white bg-slate-600 h-10 flex items-center justify-center px-6 rounded-xl transition-colors hover:bg-slate-800">Student</a>
                    </div>
                </div>
            </div>
        </>
